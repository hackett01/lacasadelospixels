...
Tags: slider, responsive slider, slide, resonsive slide, carousel, responsive carousel, carousel slider, responsive carousel slider, image slider, photo slider, banner, banner slider, slide show, slide, slider plugin, slide effects, slider effects, jquery slider, css slider, html5 slider, slider shortcode, slide shortcode, gallery slider, page slider, full width slider, full-width slider, fullscreen slider, content slider, slider layers, slider links, slider buttons, slider image, slide image, wordpress slider, wp slider, woocommerce slider, upcp slider, product slider, product catalog slider, slider transition, featured image slider, vertical slider, horizontal slider, smooth slider, easy slider, simple slider, custom slider, rotating slider, rotating banner, modern slider, sleek slider, slider custom post type, custom post type slider, slide custom post type, best slider, best slider plugin
...
* <a href="https://wordpress.org/plugins/ultimate-product-catalogue/">Ultimate Product Catalog</a> slider integration
...
* [ultimate-slider]: displays all slides that you've created
...
3. Place "[ultimate-slider]" shortcode on the page(s) where you want your slider to display
...
1. The admin table with list of slides
2. The slider options page
3. Individual slide options, showing choice of UPCP or WooCommerce integration
4. Front-end view of full-width slider
