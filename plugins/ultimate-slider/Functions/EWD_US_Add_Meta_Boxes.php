...
function EWD_US_Meta_Box( $post ) {
	...
	$WC_Products = get_posts('post_type=product&posts_per_page=-1');
	...
	//echo "<div class='ewd-us-meta-menu-item' id='Menu_Images'>" . __("Images", 'EWD_US') . "</div>";
	echo "</div>";
	...
	if ($Content_Type == "current_post") {echo "checked='checked'";}
	echo "/>";
	echo "</div>";
	...
	echo "<div class='ewd-us-meta-body ewd-us-hidden' id='Body_Images'>";
	echo "<h3>" . __("Image Options", 'EWD_US') . "</h3>";
	echo "<div class='ewd-us-meta-option-radio'>";
	echo "<input type='radio' name='use_image' value='featured' />";
	echo "</div>";
	echo "<div class='ewd-us-meta-option-explanation'>";
	echo __("Use post's featured image", 'EWD_US');
	echo "</div>";
	echo "<div class='ewd-us-meta-option-radio'>";
	echo "<input type='radio' name='use_image' value='content' />";
	echo "</div>";
	echo "<div class='ewd-us-meta-option-explanation'>";
	echo __("Use first image in post content", 'EWD_US');
	echo "</div>";
	echo "</div>";

	echo "<div class='ewd-us-clear'></div>";
}
