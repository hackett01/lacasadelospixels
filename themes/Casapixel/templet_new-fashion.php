        ...
        <div class="vista-desktop">
            <div class="container">
                ...
                <div class="col-sm-6 col-sm-offset-6">
                    ...
                    <a href="<?php the_field('link_pagina'); ?>" class="emerald-btn wow fadeIn" target="_blank" data-wow-duration="1s" data-wow-delay="1s">Visitar su sitio</a>
                </div>
            </div>
        </div><!-- Desktop -->
...
<script src="<?php echo get_site_url(); ?>/wp-content/themes/Casapixel/js/funtion_color_fashion.js"></script>
<?php get_footer(); ?>
