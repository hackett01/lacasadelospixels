...
function fastertheme_framework_page() {
                                ...
                                <div class="faster-inner-tab-group active">
                                    <div class="ft-control">
                                        <input id="logo-img" class="upload" type="text" name="faster_theme_options[logo]" 
                                               value="<?php if (!empty($generator_options['logo'])) {
                                ...
                                <div class="faster-inner-tab-group">
                                    ...
                                    <div class="ft-control">
                                        <input id="favicon-img" class="upload" type="text" name="faster_theme_options[favicon]" 
                                               value="<?php if (!empty($generator_options['favicon'])) {
                            ...
                            <div id="section-footertext" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input type="text" id="footertext" class="of-input" name="faster_theme_options[footertext]" size="32"  value="<?php if (!empty($generator_options['footertext'])) {
                            ...
                            <div id="section-email" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input type="text" id="email" class="of-input" name="faster_theme_options[email]" size="32"  value="<?php if (!empty($generator_options['email'])) {
                            ...
                            <div id="section-phone" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input type="text" id="phone" class="of-input" name="faster_theme_options[phone]" size="32"  value="<?php if (!empty($generator_options['phone'])) {
    ...
    <?php for ($generator_i = 1; $generator_i <= 5; $generator_i++): ?> 
                                    ...
                                    <div class="faster-inner-tab-group">
                                        <div class="ft-control">
                                            <input id="slider-img-<?php echo $generator_i; ?>" class="upload" type="text" name="faster_theme_options[slider-img-<?php echo $generator_i; ?>]" 
                                                   value="<?php if (!empty($generator_options['slider-img-' . $generator_i])) {
                            echo esc_url($generator_options['slider-img-' . $generator_i]);
                        } ?>" placeholder="<?php _e('No file chosen', 'generator') ?>" />
        ...
        <?php } ?>
                                        ...
                                        <div class="ft-control">
                                            <input type="text" placeholder="Slide<?php echo $generator_i; ?> Link" id="slidelink-<?php echo $generator_i; ?>" class="of-input" name="faster_theme_options[slidelink-<?php echo $generator_i; ?>]" size="32"  value="<?php if (!empty($generator_options['slidelink-' . $generator_i])) {
            echo esc_attr($generator_options['slidelink-' . $generator_i]);
        } ?>">
                                        </div>
                            ...
                            <div id="section-title" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input id="title" class="of-input" name="faster_theme_options[home-title]" type="text" size="50" value="<?php if (!empty($generator_options['home-title'])) {
        echo esc_attr($generator_options['home-title']);
    } ?>" />
                                    </div>                
                                </div>
                            </div>
                            <div class="section theme-tabs theme-short_description">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <textarea name="faster_theme_options[home-content]" rows="6" id="home-content1" class="of-input"><?php if (!empty($generator_options['home-content'])) {
        echo $generator_options['home-content'];
    } ?></textarea>
                                    </div>                
                                </div>
                            </div>
    ...
    <?php for ($generator_section_i = 1; $generator_section_i <= 4; $generator_section_i++): ?>
                                    ...
                                    <div class="faster-inner-tab-group">
                                        <div class="ft-control">
                                            <input id="first-image-<?php echo $generator_section_i; ?>" class="upload" type="text" name="faster_theme_options[home-icon-<?php echo $generator_section_i; ?>]" 
                                                   value="<?php if (!empty($generator_options['home-icon-' . $generator_section_i])) {
                            echo esc_url($generator_options['home-icon-' . $generator_section_i]);
                        } ?>" placeholder="<?php _e('No file chosen', 'generator') ?>" />
                                            <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload', 'generator') ?>" />
        ...
        <?php } ?>
                                        ...
                                        <div class="ft-control">
                                            ...
                                            <input type="text" placeholder="<?php _e('Enter title here', 'generator') ?>" id="title-<?php echo $generator_section_i; ?>" class="of-input" name="faster_theme_options[section-title-<?php echo $generator_section_i; ?>]" size="32"  value="<?php if (!empty($generator_options['section-title-' . $generator_section_i])) {
                                            echo esc_attr($generator_options['section-title-' . $generator_section_i]);
                                        } ?>">
                                        </div>
                                        <div class="ft-control">
                                            ...
                                            <textarea name="faster_theme_options[section-content-<?php echo $generator_section_i; ?>]" rows="6" id="content-<?php echo $generator_section_i; ?>" placeholder="<?php _e('Enter Content here', 'generator') ?>" class="of-input"><?php if (!empty($generator_options['section-content-' . $generator_section_i])) {
                                            echo $generator_options['section-content-' . $generator_section_i];
                                        } ?></textarea>
                            ...
                            <div id="section-recent-title" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input id="post" class="of-input" name="faster_theme_options[post-title]" type="text" size="50" value="<?php if (!empty($generator_options['post-title'])) {
                                            echo esc_attr($generator_options['post-title']);
                                        } ?>" />
                                    </div>                
                                </div>
                            </div>
                            ...
                            <div id="section-facebook" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group active">
                                    <div class="ft-control">
                                        ...
                                        <input id="facebook" class="of-input" name="faster_theme_options[fburl]" size="30" type="text" value="<?php if (!empty($generator_options['fburl'])) {
                            ...
                            <div id="section-twitter" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input id="twitter" class="of-input" name="faster_theme_options[twitter]" type="text" size="30" value="<?php if (!empty($generator_options['twitter'])) {
                            ...
                            <div id="section-dribbble" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input id="dribbble" class="of-input" name="faster_theme_options[dribbble]" type="text" size="30" value="<?php if (!empty($generator_options['dribbble'])) {
                            ...
                            <div id="section-linkedin" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input id="linkedin" class="of-input" name="faster_theme_options[linkedin]" type="text" size="30" value="<?php if (!empty($generator_options['linkedin'])) {
                            ...
                            <div id="section-rss" class="section theme-tabs">
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        ...
                                        <input id="rss" class="of-input" name="faster_theme_options[rss]" type="text" size="30" value="<?php if (!empty($generator_options['rss'])) {
