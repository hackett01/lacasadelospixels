<?php /* Template Name: Identidad Coporativa */ ?>


<?php get_header(); ?>
<div class="ych-menu-content"><div id="servicios-diseno-web" class="servicio">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                if (!empty($image)):
                    ?>
                    <div style="    background-image: url('<?php echo $image['url']; ?>'); height: 376px;" class="col-md-4 col-sm-6 servicio-pic item-match pic-1" data-parallax="scroll"  data-z-index="10"></div><!-- Imagen 1 -->
                <?php endif; ?>
                ...
                <div class="col-md-4 col-sm-6 servicio-content item-match">
                    <div class="inner wow   fadeIn"  data-wow-duration="2s" data-wow-delay="0.5s">
                        ...
                        <?php
                        $image = get_field('imagen_guy');

                        if (!empty($image)):
                            ?>
                            <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
                        <?php endif; ?>
                        <h2><?php the_field('title_competitors'); ?></h2>
                        <p><?php the_field('content_text_competitors'); ?></p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4  col-sm-6 col-sm-pull-6 col-md-pull-0 servicio-content item-match">
                    <div class="inner wow  fadeIn"  data-wow-duration="2s" data-wow-delay="0.5s">
                        ...
                        <p><?php the_field('content_text_products'); ?></p>
                    </div>
                </div>
                ...
                if (!empty($image)):
                    ?>
                    <div style="    background-image: url('<?php echo $image['url']; ?>'); height: 518px;" class="col-md-4 col-sm-6 servicio-pic item-match pic-1" data-parallax="scroll"  data-z-index="10"></div><!-- Imagen 1 -->
                <?php endif; ?>
                <div class="col-md-4  col-sm-6 servicio-content item-match">
                    <div class="inner wow   fadeIn"  data-wow-duration="2s" data-wow-delay="0.5s">
                        ...
                        <h2><?php the_field('title_sales'); ?></h2>
                        <p><?php the_field('title_text_sales'); ?></p>
                    </div>
                </div>
            </div>
        </div><!-- Content -->
